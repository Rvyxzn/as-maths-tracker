...
const ECO_QUESTIONS = [
 ...
 },
 {
  ...
  "marks": 5,
  "section": "A",
  "text": "In a major reform of its command economy, the Cuban government will allow small private businesses to operate in most fields. Free market economists have long called for the role of small business to be expanded to help jump‑start the economy and to create jobs. cuba-allows-massive-expansion-private-businesses/)\n(a) With reference to the information provided, explain one advantage of a free market economy.\n(4)\n\n(b) Which one of the following economic thinkers supported the idea of a command economy?\n(1)\nA Adam Smith\nB Friedrich Hayek\nC John Maynard Keynes\nD Karl Marx",
